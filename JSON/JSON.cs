 ...
 * JSON.cs
 * 
 * (c) Patrick van Bergen 2008
 * http://techblog.procurios.nl/k/618/news/view/14605/14863/How-do-I-write-my-own-parser-for-JSON.html
 * Portions (c) Lane Haury 2009
 * lane@fort-awesome.net
 * 
 * Last updated 2009.10.20
 * 
 * The code may be used without cost or obligation.
 *
 */
#endregion
...
namespace FortAwesomeUtil.JSON
{
    /// <summary>
    ...
    public class JSON
    {
        ...
        protected IDictionary<string, object> ParseObject(char[] json, ref int index)
        {
        ...
        protected IList<object> ParseArray(char[] json, ref int index)
        {
        ...
        {
            if (objectOrArray is IDictionary<string, object>)
            {
                return SerializeObject((IDictionary<string, object>)objectOrArray, builder);
            }
            else if (objectOrArray is IList<object>)
            {
                return SerializeArray((IList<Object>)objectOrArray, builder);
            }
            else
            {
                return false;
        ...
        protected bool SerializeObject(IDictionary<string, object> anObject, StringBuilder builder)
        {
            builder.Append("{");
        ...
        protected bool SerializeArray(IList<object> anArray, StringBuilder builder)
        {
            builder.Append("[");
        ...
        protected bool SerializeValue(object value, StringBuilder builder)
        {
            ...
            {
                SerializeObject((IDictionary<string, object>)value, builder);
            }
            else if (value is IList<object>)
            {
                SerializeArray((IList<object>)value, builder);
            }
